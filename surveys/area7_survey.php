...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            header("Location: ../submission_success.php?program=" . urlencode($program) . "&role=" . urlencode($role) . "&area=area7");
            exit();
        } else {
...
<head>
    ...
    <title>Area 7 Survey - Research</title>
    <!-- Google Fonts: Outfit -->
...
<body>
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <button type="submit">Submit Area 7 Survey</button>
        </form>
    </div>
</body>
</html>
